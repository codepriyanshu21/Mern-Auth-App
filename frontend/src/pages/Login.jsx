        ...
        <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
            ...
            <form onSubmit={onSubmitHandler}>
                {state==='Sign Up' &&(
                    ...
                    value={name}
                    className='px-1 bg-transparent text-white outline-none' type="text" placeholder="Full Name" required/>
                </div>
                )}
                ...
                <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                    ...
                    value={email}
                     className='px-1 bg-transparent text-white outline-none' type="text" placeholder="Email Address" required/>
                </div>
                ...
                <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                    ...
                    value={password}
                    className='px-1 bg-transparent text-white outline-none' type="password" placeholder="Password" required/>
                </div>
            ...
            {state==='Sign Up' ? (
                ...
                <span onClick={()=>setState('Sign Up')} className='text-blue-500 cursor-pointer underline'>Sign Up</span>
            </p>
            )}
